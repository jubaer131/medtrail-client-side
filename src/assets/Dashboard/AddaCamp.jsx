...
const AddaCamp = () => {
    ...
    return (
        ...
        <div className="max-w-7xl mx-auto rounded-3xl p-4 flex  justify-center gap-5 shadow-md   bg-cover lg:mt-12 shadow-lime-500 hover:shadow-emerald-500">
            <div className="w-1/2 max-sm:hidden bg-cover bg-no-repeat bg-[url('https://i.ibb.co/PtMGbnT/irak-313-1.jpg')]">

            </div >

            <div className="lg:w-1/2 px-6">

                <h1 className="text-center text-3xl font-semibold   mb-5">Add medical Camp</h1>
